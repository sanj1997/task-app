    ...
    <div className="flex justify-evenly p-8 items-center">
      <div className="xs:full sm:full md:4/12 lg:w-3/12 p-7 border border-grey-600 shadow-lg">
        ...
        <form className=" w-full flex flex-col">
          ...
          <button className="bg-black text-white py-2 text-xs mt-5 border rounded">Login</button>
        </form>
        <div className="mt-2">
        <span className="flex justify-center m-auto w-full"><p className="text-xs font-thin px-1">Don't have an Account?</p><p className="cursor-pointer font-bold text-xs px-1">Register</p></span>
      </div>
      </div>
